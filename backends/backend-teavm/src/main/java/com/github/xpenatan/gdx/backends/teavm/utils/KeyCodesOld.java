...
public class KeyCodesOld {
    ...
    /**
     * Key code for {@link KeyCodesOld#KEY_WIN_KEY_LEFT_META} that Firefox fires
     * for the meta key.
     */
     ...
     * <p>
     * This method simplifies RTL handling in your code: <code><pre>
    ...
    public static int keyForCode(int keyCode) {
        switch(keyCode) {
            case KeyCodesOld.KEY_ALT:
                return Keys.ALT_LEFT;
            case KeyCodesOld.KEY_BACKSPACE:
                return Keys.BACKSPACE;
            case KeyCodesOld.KEY_CTRL:
                return Keys.CONTROL_LEFT;
            case KeyCodesOld.KEY_DELETE:
                return Keys.FORWARD_DEL;
            case KeyCodesOld.KEY_DOWN:
                return Keys.DOWN;
            case KeyCodesOld.KEY_END:
                return Keys.END;
            case KeyCodesOld.KEY_ENTER:
                return Keys.ENTER;
            case KeyCodesOld.KEY_ESCAPE:
                return Keys.ESCAPE;
            case KeyCodesOld.KEY_HOME:
                return Keys.HOME;
            case KeyCodesOld.KEY_LEFT:
                return Keys.LEFT;
            case KeyCodesOld.KEY_PAGEDOWN:
                return Keys.PAGE_DOWN;
            case KeyCodesOld.KEY_PAGEUP:
                return Keys.PAGE_UP;
            case KeyCodesOld.KEY_RIGHT:
                return Keys.RIGHT;
            case KeyCodesOld.KEY_SHIFT:
                return Keys.SHIFT_LEFT;
            case KeyCodesOld.KEY_TAB:
                return Keys.TAB;
            case KeyCodesOld.KEY_UP:
                return Keys.UP;
            case KeyCodesOld.KEY_PAUSE:
                return Keys.UNKNOWN; // FIXME
            case KeyCodesOld.KEY_CAPS_LOCK:
                return Keys.UNKNOWN; // FIXME
            case KeyCodesOld.KEY_SPACE:
                return Keys.SPACE;
            case KeyCodesOld.KEY_INSERT:
                return Keys.INSERT;
            case KeyCodesOld.KEY_0:
                return Keys.NUM_0;
            case KeyCodesOld.KEY_1:
                return Keys.NUM_1;
            case KeyCodesOld.KEY_2:
                return Keys.NUM_2;
            case KeyCodesOld.KEY_3:
                return Keys.NUM_3;
            case KeyCodesOld.KEY_4:
                return Keys.NUM_4;
            case KeyCodesOld.KEY_5:
                return Keys.NUM_5;
            case KeyCodesOld.KEY_6:
                return Keys.NUM_6;
            case KeyCodesOld.KEY_7:
                return Keys.NUM_7;
            case KeyCodesOld.KEY_8:
                return Keys.NUM_8;
            case KeyCodesOld.KEY_9:
                return Keys.NUM_9;
            case KeyCodesOld.KEY_A:
                return Keys.A;
            case KeyCodesOld.KEY_B:
                return Keys.B;
            case KeyCodesOld.KEY_C:
                return Keys.C;
            case KeyCodesOld.KEY_D:
                return Keys.D;
            case KeyCodesOld.KEY_E:
                return Keys.E;
            case KeyCodesOld.KEY_F:
                return Keys.F;
            case KeyCodesOld.KEY_G:
                return Keys.G;
            case KeyCodesOld.KEY_H:
                return Keys.H;
            case KeyCodesOld.KEY_I:
                return Keys.I;
            case KeyCodesOld.KEY_J:
                return Keys.J;
            case KeyCodesOld.KEY_K:
                return Keys.K;
            case KeyCodesOld.KEY_L:
                return Keys.L;
            case KeyCodesOld.KEY_M:
                return Keys.M;
            case KeyCodesOld.KEY_N:
                return Keys.N;
            case KeyCodesOld.KEY_O:
                return Keys.O;
            case KeyCodesOld.KEY_P:
                return Keys.P;
            case KeyCodesOld.KEY_Q:
                return Keys.Q;
            case KeyCodesOld.KEY_R:
                return Keys.R;
            case KeyCodesOld.KEY_S:
                return Keys.S;
            case KeyCodesOld.KEY_T:
                return Keys.T;
            case KeyCodesOld.KEY_U:
                return Keys.U;
            case KeyCodesOld.KEY_V:
                return Keys.V;
            case KeyCodesOld.KEY_W:
                return Keys.W;
            case KeyCodesOld.KEY_X:
                return Keys.X;
            case KeyCodesOld.KEY_Y:
                return Keys.Y;
            case KeyCodesOld.KEY_Z:
                return Keys.Z;
            case KeyCodesOld.KEY_LEFT_WINDOW_KEY:
                return Keys.UNKNOWN; // FIXME
            case KeyCodesOld.KEY_RIGHT_WINDOW_KEY:
                return Keys.UNKNOWN; // FIXME
            // case KEY_SELECT_KEY: return Keys.SELECT_KEY;
            case KeyCodesOld.KEY_NUMPAD0:
                return Keys.NUMPAD_0;
            case KeyCodesOld.KEY_NUMPAD1:
                return Keys.NUMPAD_1;
            case KeyCodesOld.KEY_NUMPAD2:
                return Keys.NUMPAD_2;
            case KeyCodesOld.KEY_NUMPAD3:
                return Keys.NUMPAD_3;
            case KeyCodesOld.KEY_NUMPAD4:
                return Keys.NUMPAD_4;
            case KeyCodesOld.KEY_NUMPAD5:
                return Keys.NUMPAD_5;
            case KeyCodesOld.KEY_NUMPAD6:
                return Keys.NUMPAD_6;
            case KeyCodesOld.KEY_NUMPAD7:
                return Keys.NUMPAD_7;
            case KeyCodesOld.KEY_NUMPAD8:
                return Keys.NUMPAD_8;
            case KeyCodesOld.KEY_NUMPAD9:
                return Keys.NUMPAD_9;
            case KeyCodesOld.KEY_MULTIPLY:
                return Keys.UNKNOWN; // FIXME
            case KeyCodesOld.KEY_ADD:
                return Keys.PLUS;
            case KeyCodesOld.KEY_SUBTRACT:
                return Keys.MINUS;
            case KeyCodesOld.KEY_DECIMAL_POINT_KEY:
                return Keys.PERIOD;
            case KeyCodesOld.KEY_DIVIDE:
                return Keys.UNKNOWN; // FIXME
            case KeyCodesOld.KEY_F1:
                return Keys.F1;
            case KeyCodesOld.KEY_F2:
                return Keys.F2;
            case KeyCodesOld.KEY_F3:
                return Keys.F3;
            case KeyCodesOld.KEY_F4:
                return Keys.F4;
            case KeyCodesOld.KEY_F5:
                return Keys.F5;
            case KeyCodesOld.KEY_F6:
                return Keys.F6;
            case KeyCodesOld.KEY_F7:
                return Keys.F7;
            case KeyCodesOld.KEY_F8:
                return Keys.F8;
            case KeyCodesOld.KEY_F9:
                return Keys.F9;
            case KeyCodesOld.KEY_F10:
                return Keys.F10;
            case KeyCodesOld.KEY_F11:
                return Keys.F11;
            case KeyCodesOld.KEY_F12:
                return Keys.F12;
            case KeyCodesOld.KEY_NUM_LOCK:
                return Keys.NUM;
            case KeyCodesOld.KEY_SCROLL_LOCK:
                return Keys.UNKNOWN; // FIXME
            case KeyCodesOld.KEY_SEMICOLON:
                return Keys.SEMICOLON;
            case KeyCodesOld.KEY_EQUALS:
                return Keys.EQUALS;
            case KeyCodesOld.KEY_COMMA:
                return Keys.COMMA;
            case KeyCodesOld.KEY_DASH:
                return Keys.MINUS;
            case KeyCodesOld.KEY_PERIOD:
                return Keys.PERIOD;
            case KeyCodesOld.KEY_FORWARD_SLASH:
                return Keys.SLASH;
            case KeyCodesOld.KEY_GRAVE_ACCENT:
                return Keys.UNKNOWN; // FIXME
            case KeyCodesOld.KEY_OPEN_BRACKET:
                return Keys.LEFT_BRACKET;
            case KeyCodesOld.KEY_BACKSLASH:
                return Keys.BACKSLASH;
            case KeyCodesOld.KEY_CLOSE_BRACKET:
                return Keys.RIGHT_BRACKET;
            case KeyCodesOld.KEY_SINGLE_QUOTE:
